                                        ...
                                        <List
                                            ...
                                            renderItem={(blog) => (
                                                <List.Item
                                                    ...
                                                    className="border rounded-lg mb-4 p-4 shadow-sm hover:shadow-md transition-shadow duration-200 cursor-pointer"
                                                    onClick={() => handleBlogClick(blog.id)}
                                                >
                                                    <List.Item.Meta
                                                        avatar={<Avatar src={blog.author.image} size={48} />}
                                                        title={<Text className="text-lg font-semibold hover:text-blue-600">{blog.title}</Text>}
                                                        description={
